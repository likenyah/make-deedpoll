% Template for a doubly-witnessed deed poll
%
% NOTE: I AM NOT A LAWYER, but since (as far as I know) you can write a valid
%       deed poll on a napkin, this should be more than enough.
...
% hyperref Setup
\hypersetup{
	pdfauthor   = make-deedpoll vVERSION,
...
% Disable visible page numbering
